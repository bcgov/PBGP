      ...
      <Box p={4}>
        {
          error ? (
            <Typography variant='h6'>
              Failed to retrieve the submission with id {id}
            </Typography>
          ) : (
                ...
                </Grid>
                {
                  formValues.submissionType === 'organization' ?
                    ...
                    : formValues.submissionType === 'operator' ?
                      ['acute_care', 'ems', 'lab_services', 'dsl_ltc'].includes(formValues.data.category) ? (
                        ...
                        : formValues.data.category === 'home_care' ?
                          ...
                          : formValues.data[formValues.data.category].map(
